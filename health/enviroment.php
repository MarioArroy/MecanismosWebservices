...
<body class="no-select contentScroll">
                ...
                <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu dropdown_menu--animated dropdown_menu-7">
                            ...
                            <a class="dropdown-item dropdown-item_Hover" href="projectUpdate.php">Actualización del proyecto</a>
                          </div>
                        </li>
                        <li class="nav-item dropdown">
    ...
    <div class="row">
    	...
    	<div class="col-sm-10">	
          ...
          <h4>Introducción al proyecto</h4>
          <hr>
    			<p>Deepin es un sistema operativo de escritorio doméstico elegante, fácil de usar y confiable lanzado por Deepin Technology Co., Ltd. Las aplicaciones destacadas de Deepin han sido preinstaladas en el sistema operativo. Le permite experimentar una variedad de actividades recreativas, pero también para satisfacer sus necesidades diarias. Con funciones continuamente mejoradas y perfeccionadas, creemos que Deepin será amado y utilizado por más y más usuarios.</p>
    		</div>
        ...
        <div class="container-fluid fluentContaint p-4">
          ...
          <hr>
          <p>Ubicación del código fuente:</p>
